  ...
  return (
    <>
      <section className="relative scroll-mt-[4.5rem]" id="home">
        ...
        <div className="rmx-auto max-w-7xl relative md:px-6 text-default lg:py-10 md:py-5 px-4 py-3">
              ...
              <div className="self-center md:w-1/2">
                <div className="text-lg mb-12 text-justify">
                  ...
                  <p>
                    ...
                    development and I'm looking for a job in a company that
                    allows me to grow as a professional.
                  </p>
                  <br />
                  <p>
                    I know I might be lacking real world experience, but I'm
                    confident I can quickly grow my skills and become a pillar
                    in any company.
                  </p>
                  <br />
                  <p>🗺️ Asturias, Spain</p>
                </div>
